...
description: Orchestrate an agents team to implement a change in parallel using a dispec-driven distribution plan. Use when the user has completed /opsx:multiagent planning and wants to start multi-agent execution. ONLY FOR MEDIUM AND LARGE IMPLEMENTATIONS
license: MIT
